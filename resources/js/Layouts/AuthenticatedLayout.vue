...
<template>
    ...
    <div>
        <aside :class="[ isSidebarOpen ? 'translate-x-[-250px]' : 'w-[250px]']"
               class="h-screen overflow-y-scroll sidebar-t fixed z-[999] left-0 top-0 shadow transition-all scrollbar-none">
            <div class="sticky sidebar-t top-0 left-0 py-5 flex items-center justify-center px-5">
