...
class StoreInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'clinical_test_information.*.test_id' => ['required', 'required_with:schedule_of_work_information.*.test_id', 'integer'],
            'clinical_test_information.*.amount' => ['required', 'required_with:schedule_of_work_information.*.amount', 'numeric'],
        ];
    }
    ...
    {
        return [
            'invoice_date.date_format' => 'The bill date must be in the format Y-m-d.',
